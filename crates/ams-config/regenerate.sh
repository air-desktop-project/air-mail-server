...
capnp compile -I schema --src-prefix schema \
  ...
  schema/ams-scram.capnp schema/ams-devices.capnp schema/ams-app-passwords.capnp schema/ams-journal.capnp schema/ams-delegations.capnp || {
...
# oublie de corriger.
for schema in ams_config ams_accounts ams_index ams_scram ams_devices ams_app_passwords ams_journal ams_delegations; do
