...
pub mod configuration {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,8,3,7,1,2,6,5,4,9];
...
pub mod limits {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 133] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(178, 7, 0, 0, 150, 8, 0, 0),
...
pub mod timeouts {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(132, 12, 0, 0, 206, 12, 0, 0),
