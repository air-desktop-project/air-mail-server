...
pub mod configuration {
    ...
    impl <> ::capnp::traits::HasStructSize for Builder<'_,>  {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize = ::capnp::private::layout::StructSize { data: 2, pointers: 17 };
    }
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 334] = [
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[11,16,14,0,8,3,7,1,19,17,15,12,2,6,5,4,13,9,10,18];
...
pub mod dkim {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(77, 22, 0, 0, 231, 24, 0, 0),
...
pub mod tls {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(165, 27, 0, 0, 147, 29, 0, 0),
...
pub mod spf {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 74] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(194, 30, 0, 0, 124, 35, 0, 0),
            ::capnp::word(21, 0, 0, 0, 170, 0, 0, 0),
    ...
    pub(crate) static ENCODED_NODE: [::capnp::Word; 28] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(105, 34, 0, 0, 122, 35, 0, 0),
...
pub mod dmarc {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 152] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(83, 36, 0, 0, 221, 50, 0, 0),
    ...
    pub(crate) static ENCODED_NODE: [::capnp::Word; 28] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(189, 48, 0, 0, 219, 50, 0, 0),
...
pub mod limits {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 133] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(47, 51, 0, 0, 19, 52, 0, 0),
...
pub mod guard {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 151] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(125, 52, 0, 0, 183, 57, 0, 0),
            ::capnp::word(21, 0, 0, 0, 186, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod timeouts {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(48, 58, 0, 0, 122, 58, 0, 0),
