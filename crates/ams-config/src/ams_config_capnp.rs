...
pub mod configuration {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[11,16,14,0,8,3,7,1,19,17,15,12,2,6,5,4,20,13,9,10,18];
...
pub mod relay {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 96] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(171, 22, 0, 0, 120, 28, 0, 0),
...
pub mod dkim {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(129, 29, 0, 0, 27, 32, 0, 0),
...
pub mod tls {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(217, 34, 0, 0, 199, 36, 0, 0),
...
pub mod spf {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 74] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(246, 37, 0, 0, 176, 42, 0, 0),
            ::capnp::word(21, 0, 0, 0, 170, 0, 0, 0),
    ...
    pub(crate) static ENCODED_NODE: [::capnp::Word; 28] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(157, 41, 0, 0, 174, 42, 0, 0),
...
pub mod dmarc {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 152] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(135, 43, 0, 0, 17, 58, 0, 0),
            ::capnp::word(21, 0, 0, 0, 186, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 23, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub(crate) static ENCODED_NODE: [::capnp::Word; 28] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(241, 55, 0, 0, 15, 58, 0, 0),
...
pub mod limits {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 133] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(99, 58, 0, 0, 71, 59, 0, 0),
...
pub mod guard {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 151] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(177, 59, 0, 0, 235, 64, 0, 0),
            ::capnp::word(21, 0, 0, 0, 186, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod timeouts {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(100, 65, 0, 0, 174, 65, 0, 0),
